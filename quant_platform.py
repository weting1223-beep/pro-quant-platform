...
with st.sidebar.expander("📊 網站流量資訊", expanded=False):
    ...
    st.image("https://visitor-badge.laobi.icu/badge?page_id=pro_quant_platform_final_v9", caption="總瀏覽人次")
...
def page_learn():
    ...
    cat = st.selectbox("請選擇分類", list(terms.keys()))
    term = st.selectbox("請選擇詞彙", list(terms[cat].keys()))
    st.info(f"### 💡 {term}\n\n{terms[cat][term]}")
...
def page_resources():
    ...
    with col1:
        ...
        * [🎵 Spotify](https://open.spotify.com/show/3n0Q7aZqZ9jZ9jZ9jZ9jZ)
        """)
    ...
    with col2:
        ...
        * [🎵 Spotify](https://open.spotify.com/show/0jZ9jZ9jZ9jZ9jZ9jZ9jZ)
        """)
